...
class PomodoroTimer:
    ...
    def reset_clock(self):
        self.change_pomodoro_time.configure(state='enabled')
        self.change_short_break_time.configure(state='enabled')
        self.change_long_break_time.configure(state='enabled')
        self.stopped = True
        self.skipped = False
        self.pomodoros = 0
